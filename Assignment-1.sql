...
select distinct(count(first_name)) as Unique_first_names
from actor;

-- Display the first 10 records from customers table
select * 
from customer
limit 10;

-- Display the first 3 records from the customer table whose first name starts wtih 'b'
select *
from customer
where first_name like 'b%' order by first_name asc limit 3;

-- Display the names of the first 5 movies which are rated as ‘G’.
select * 
from film 
where rating = 'G' order by title asc limit 5;
...
select *
from city
where city like 'a%a' order by city asc limit 4;
...
-- Find all the customers whose first name starts with 'a' and are at least 5 character in length
select *
from customer
where first_name like 'a%' and length(first_name) >= 5;

-- find all the customers first name starts with 'a' and ends with 'o'
select *
from customer
